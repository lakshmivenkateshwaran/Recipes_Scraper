...
class RecipesSpider(scrapy.Spider):
    name = 'mushroom_recipes'
    page_number = 2
    start_urls = ['https://www.vegrecipesofindia.com/recipes/mushroom/']
    ...
    def parse(self, response):
        ...
        # Pagination till 3 pages
        next_page = 'https://www.vegrecipesofindia.com/recipes/mushroom/page/' + str(RecipesSpider.page_number) + '/'
        if RecipesSpider.page_number <= 4:
